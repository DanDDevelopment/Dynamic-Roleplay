# dyn-spawn
Spawn Selector for dyn-Core Framework :eagle:
...
- [dyn-houses](https://github.com/DynCore-framework/dyn-houses) - Lets player select the house
- [dyn-apartment](https://github.com/DynCore-framework/dyn-apartment) - Lets player select the apartment
- [dyn-garages](https://github.com/DynCore-framework/dyn-garages) - For house garages
