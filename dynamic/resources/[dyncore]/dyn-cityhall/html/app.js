...
$(".cityhall-option-block").click(function (e) {
    ...
    if (blockPage == "identity") {
        ...
        $.post("https://dyn-cityhall/requestLicenses", JSON.stringify({}), function (licenses) {
...
$(document).on("click", ".apply-job-button", function (e) {
    e.preventDefault();
    $.post("https://dyn-cityhall/applyJob", JSON.stringify(selectedJobId));
    ResetPages();
});
