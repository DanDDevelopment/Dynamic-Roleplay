# dyn-cityhall
City Services for dyn-Core Framework

## Dependencies
- [dyn-core](https://github.com/DynCore-framework/dyn-core)
- [PolyZone](https://github.com/mkafrin/PolyZone) - For Interaction (DrawText and dyn-target both require this)
- [dyn-target](https://github.com/BerkieBb/dyn-target) - For Interaction (Optional)
- [dyn-phone](https://github.com/DynCore-framework/dyn-phone) - For E-Mail
...
- dyn-target integration, this is optional
- PolyZone and dyn-core DrawText integration, this is optional
...
![Cityhall dyn-Target Interaction](https://i.imgur.com/K54cMLt.png)
...
![Driving School dyn-Target Interaction](https://i.imgur.com/P7jWBsV.png)
