# dyn-apartments
Apartments System for dyn-Core Framework :office:
...
- [dyn-clothing](https://github.com/DynCore-framework/dyn-clothing) - To save outfits
- [dyn-houses](https://github.com/DynCore-framework/dyn-houses) - House logic
- [dyn-interior](https://github.com/DynCore-framework/dyn-interior) - Interior logic
- [dyn-weathersync](https://github.com/DynCore-framework/dyn-weathersync) - To desync weather while inside
- [dyn-spawn](https://github.com/DynCore-framework/dyn-spawn) - To spawn the player at apartment if last location was in apartment
...
- Import `dyn-apartments.sql` in your database
