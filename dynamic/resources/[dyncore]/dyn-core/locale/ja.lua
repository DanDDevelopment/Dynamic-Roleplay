local Translations = {
    error = {
        ...
        duplicate_license           = '[DynCore] - Rockstarライセンスが重複しています',
        no_valid_license            = '[DynCore] - 有効なRockstarライセンスが見つかりません',
        not_whitelisted             = '[DynCore] - あなたはホワイトリストに登録されていません',
        ...
        connecting_database_error   = '[DynCore] - サーバーへの接続中にデータベースエラーが発生しました(SQLサーバの稼働を確認してください)',
        connecting_database_timeout = '[DynCore] - データベースへの接続がタイムアウトしました(SQLサーバーの稼働を確認してください)',
    },
    success = {
...
if GetConvar('dyn_locale', 'en') == 'ja' then
    Lang = Locale:new({
