local Translations = {
    error = {
        ...
        duplicate_license           = '[DynCore] - Duplicate Rockstar License Found',
        no_valid_license            = '[DynCore] - No Valid Rockstar License Found',
        not_whitelisted             = '[DynCore] - You\'re not whitelisted for this server',
        ...
        connecting_database_error   = '[DynCore] - A database error occurred while connecting to the server. (Is the SQL server on?)',
        connecting_database_timeout = '[DynCore] - Connection to database timed out. (Is the SQL server on?)',
    },
    success = {
