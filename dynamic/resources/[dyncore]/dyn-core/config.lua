...
QBConfig.Money.PayCheckSociety = false                              -- If true paycheck will come from the society account that the player is employed at, requires dyn-management
...
QBConfig.Player.PlayerDefaults = {
    citizenid = function() return DynCore.Player.CreateCitizenId() end,
    cid = 1,
    money = function()
        local moneyDefaults = {}
    ...
    charinfo = {
        ...
        gender = 0,
        nationality = 'USA',
        phone = function() return DynCore.Functions.CreatePhoneNumber() end,
        account = function() return DynCore.Functions.CreateAccountNumber() end
    },
    job = {
        name = 'unemployed',
        label = 'Civilian',
    ...
    metadata = {
        ...
        fingerprint = function() return DynCore.Player.CreateFingerId() end,
        walletid = function() return DynCore.Player.CreateWalletId() end,
        criminalrecord = {
            hasRecord = false,
            date = nil
        },
        ...
        phonedata = {
            SerialNumber = function() return DynCore.Player.CreateSerialNumber() end,
            InstalledApps = {}
        }
    },
