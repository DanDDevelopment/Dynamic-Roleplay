...
RegisterNetEvent('dyn-log:server:CreateLog', function(name, title, color, message, tagEveryone, imageUrl)
    local postData = {}
        ...
        local embedData = {
            {
                ...
                ['author'] = {
                    ['name'] = 'DynCore Logs',
                    ['icon_url'] = 'https://raw.githubusercontent.com/GhzGarage/dyn-media-kit/main/Display%20Pictures/Logo%20-%20Display%20Picture%20-%20Stylized%20-%20Red.png',
                },
...
DynCore.Commands.Add('testwebhook', 'Test Your Discord Webhook For Logs (God Only)', {}, false, function()
    TriggerEvent('dyn-log:server:CreateLog', 'testwebhook', 'Test Webhook', 'default', 'Webhook setup successfully')
end, 'god')
