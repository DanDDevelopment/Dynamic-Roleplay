...
ToggleNoClip = function(state)
    ...
    DynCore.Functions.Notify(IsNoClipping and Lang:t('success.noclip_enabled') or Lang:t('success.noclip_disabled'))
...
RegisterNetEvent('dyn-admin:client:ToggleNoClip', function()
