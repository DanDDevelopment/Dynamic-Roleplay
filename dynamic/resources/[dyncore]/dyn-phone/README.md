# dyn-phone
Advanced Phone for dyn-Core Framework :iphone:
...
- [apex_lawenforcement](https://github.com/DynCore-framework/apex_lawenforcement) - MEOS, handcuff check etc. 
- [dyn-crypto](https://github.com/DynCore-framework/dyn-crypto) - Crypto currency trading 
- [dyn-lapraces](https://github.com/DynCore-framework/dyn-lapraces) - Creating routes and racing 
- [dyn-houses](https://github.com/DynCore-framework/dyn-houses) - House and Key Management App
- [dyn-garages](https://github.com/DynCore-framework/dyn-garages) - For Garage App
- [dyn-banking](https://github.com/DynCore-framework/dyn-banking) - For Banking App
...
- Import `dyn-phone.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure dyn-core
ensure screenshot-basic
ensure dyn-phone
ensure apex_lawenforcement
ensure dyn-crypto
ensure dyn-lapraces
ensure dyn-houses
ensure dyn-garages
