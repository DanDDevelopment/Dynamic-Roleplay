QB.Phone.Settings = {};
QB.Phone.Settings.Background = "default-DynCore";
QB.Phone.Settings.OpenedTab = null;
QB.Phone.Settings.Backgrounds = {
    'default-DynCore': {
        label: "Standard DynCore"
    }
};
...
$(document).on('click', '#accept-background', function(e){
    ...
    $.post('https://dyn-phone/SetBackground', JSON.stringify({
...
$(document).on('click', '#accept-profilepicture', function(e){
    ...
    $.post('https://dyn-phone/UpdateProfilePicture', JSON.stringify({
