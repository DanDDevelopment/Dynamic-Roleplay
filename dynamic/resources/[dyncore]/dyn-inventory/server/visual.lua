...
function OnDropUpdate(dropId, dropData)
    ...
    TriggerClientEvent('dyn-inventory:updateDropVisualData', -1, dropId, dropData.coords, itemsTable)
end
...
AddEventHandler("playerJoining", function(source)
    ...
    TriggerClientEvent('dyn-inventory:setDropVisualData', Source, dataToSend)
end)
