...
- [dyn-logs](https://github.com/DynCore-framework/dyn-logs) - For logging transfer and other history
...
## Documentation
https://docs.DynCore.org/DynCore-documentation/DynCore-resources/dyn-inventory

## Installation
### Manual
- Download the script and put it in the `[qb]` directory.
- Import `dyn-inventory.sql` in your database
- Add the following code to your server.cfg/resouces.cfg

# Migrating from old dyn-inventory
