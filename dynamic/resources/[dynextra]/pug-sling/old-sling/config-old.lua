if Config.UseOldSlingScript then
    Config2 = {}
    Config2.CoreName = "dyn-core" -- Only change this if you have changed your core name.
    Config2.Inventory = "dyn-inventory" -- Inventory type (ox_inventory, dyn-inventory, lj-inventory etc.)
