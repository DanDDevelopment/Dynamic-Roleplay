...
-- However, if you're using a different inventory system, please refer to the "Inventory Edit | Automatic Add Weapons with images" section in dyn-mdt's README.
Config.InventoryForWeaponsImages = "dyn-inventory"

-- "LegacyFuel", "lj-fuel", "dyn-fuel"
Config.Fuel = "dyn-fuel"
...
-- This is a workaround solution because the dyn-menu present in apex_lawenforcement fills in an impound location and sends it to the event. 
