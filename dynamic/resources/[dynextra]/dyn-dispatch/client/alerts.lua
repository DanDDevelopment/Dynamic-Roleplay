...
RegisterNetEvent("dyn-dispatch:client:officerdown", function() OfficerDown() end)
...
RegisterNetEvent("dyn-dispatch:client:officerbackup", function() OfficerBackup() end)
...
RegisterNetEvent("dyn-dispatch:client:emsdown", function() EmsDown() end)
...
RegisterNetEvent('dyn-dispatch:client:sendEmergencyMsg', function(data, type, anonymous)
