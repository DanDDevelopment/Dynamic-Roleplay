...
function createExtrasMenu()
    extrasMenu = {
        ...
        },
        {
			...
			params = {
                isServer = false,
                event = "dyn-vehiclemenu:client:extrasActMenu",
            }
        },
        {
			...
			params = {
                isServer = false,
                event = "dyn-vehiclemenu:client:extrasDeactMenu",
            }
        },
		{
            header = 'Close Menu',
            ...
            params = {
                isServer = false,
                event = exports['dyn-menu']:closeMenu(),
            }
        },
    }
    exports['dyn-menu']:openMenu(extrasMenu)
end
...
function createExtrasDeactMenu()
    extrasDeactMenu = {
        ...
        },
        {
			...
			params = {
                isServer = false,
                event = "dyn-vehiclemenu:vehicleExtras",
                args = 1
            }
        },
        {
        ...
        },
        {
            ...
            params = {
                isServer = false,
                event = 'dyn-vehiclemenu:client:extrasMenu',
            }
        },
		{
            header = 'Close Menu',
    ...
    exports['dyn-menu']:openMenu(extrasDeactMenu)
end
...
function createExtrasActMenu()
    ...
    exports['dyn-menu']:openMenu(extrasActMenu)
end

RegisterNetEvent('dyn-vehiclemenu:vehicleExtras', function(args)
    local playerPed = PlayerPedId()
    local veh = GetVehiclePedIsIn(playerPed)
    local plate = GetVehicleNumberPlateText(veh)
    if veh ~= nil then
        if veh == true then
            DynCore.Functions.Notify('Not In A Vehicle..')
        else
            ...
            if DoesExtraExist(veh, 1) then
                ...
                if args == 1 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 1 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 2 then 
                    SetVehicleExtra(veh, 1, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 1 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 2) then
                ...
                if args == 3 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 2 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 4 then 
                    SetVehicleExtra(veh, 2, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 2 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 3) then
                ...
                if args == 5 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 3 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 6 then 
                    SetVehicleExtra(veh, 3, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 3 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 4) then
                ...
                if args == 7 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 4 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 8 then 
                    SetVehicleExtra(veh, 4, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 4 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 5) then
                ...
                if args == 9 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 5 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 10 then 
                    SetVehicleExtra(veh, 5, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 5 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 6) then
                ...
                if args == 11 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 6 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 12 then 
                    SetVehicleExtra(veh, 6, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 6 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 7) then
                ...
                if args == 13 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 7 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 14 then 
                    SetVehicleExtra(veh, 7, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 7 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 8) then
                ...
                if args == 15 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 8 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 16 then 
                    SetVehicleExtra(veh, 8, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 8 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 9) then
                ...
                if args == 17 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 9 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 18 then 
                    SetVehicleExtra(veh, 9, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 9 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 10) then
                ...
                if args == 19 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 10 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 20 then 
                    SetVehicleExtra(veh, 10, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 10 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 11) then
                ...
                if args == 21 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 11 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 22 then 
                    SetVehicleExtra(veh, 11, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 11 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 12) then
                ...
                if args == 23 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 12 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 24 then 
                    SetVehicleExtra(veh, 12, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 12 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
            if DoesExtraExist(veh, 13) then
                ...
                if args == 25 then 
                    ...
                    DynCore.Functions.Notify('Extra ' .. 13 .. ' Deactivated', 'error', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasDeactMenu')
                elseif args == 26 then 
                    SetVehicleExtra(veh, 13, 0)
                    SetVehicleAutoRepairDisabled(true)
                    DynCore.Functions.Notify('Extra ' .. 13 .. ' Activated', 'success', 2500)
                    TriggerEvent('dyn-vehiclemenu:client:extrasActMenu')
                end
            end
			if DoesExtraExist(veh) then
				...
				if args == 27 then
					SetVehicleAutoRepairDisabled(true)
					DynCore.Functions.Notify('All extras are Deactivated', 'error', 2500)
					TriggerEvent('dyn-vehiclemenu:alldisable')
				elseif args == 28 then 
					SetVehicleAutoRepairDisabled(true)
					DynCore.Functions.Notify('All extras are Activated', 'success', 2500)
					TriggerEvent('dyn-vehiclemenu:allenable')
				end
			end
			if not DoesExtraExist(veh) then
				DynCore.Functions.Notify('This extra is not present on this vehicle ', 'error', 2500)
			end
        end
    end
end)

RegisterNetEvent('dyn-vehiclemenu:alleExtras', function(args)
    local playerPed = PlayerPedId()
    local veh = GetVehiclePedIsIn(playerPed)
    local plate = GetVehicleNumberPlateText(veh)
	if veh ~= nil then
...
RegisterNetEvent('dyn-vehiclemenu:allenable', function()
	local playerPed = PlayerPedId()
    local veh = GetVehiclePedIsIn(playerPed)
	SetVehicleAutoRepairDisabled(true)
	if DoesExtraExist(veh, 1) then
...
RegisterNetEvent('dyn-vehiclemenu:alldisable', function()
	local playerPed = PlayerPedId()
    local veh = GetVehiclePedIsIn(playerPed)
	SetVehicleAutoRepairDisabled(true)
    SetVehicleExtra(veh, 1, 1)
...
-- events
RegisterNetEvent('dyn-vehiclemenu:client:extrasMenu', function()
	local PlayerPed = PlayerPedId()		
	if IsPedInAnyVehicle(PlayerPed, false) then
		local veh = GetVehiclePedIsUsing(PlayerPed)
		if GetPedInVehicleSeat(veh, -1) == PlayerPed then
			if GetVehicleClass(veh) == 18 then
				...
				DynCore.Functions.Notify('Thats not emergency vehicle', 'error', 2500)
			end
		else
			DynCore.Functions.Notify('You have to be on driver seat', 'error', 2500)
		end
	end
end)

RegisterNetEvent('dyn-vehiclemenu:client:extrasActMenu', function()
    createExtrasActMenu()
    exports['dyn-menu']:openMenu(extrasActMenu)
end)

RegisterNetEvent('dyn-vehiclemenu:client:extrasDeactMenu', function()
