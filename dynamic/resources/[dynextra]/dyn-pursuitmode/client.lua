...
local function changeVehicleMode(vehicle)
    ...
    TriggerEvent('dyn-pursuitmode:vehicleModeChanged', currentVehicleMode)
end
...
RegisterNetEvent('dyn-pursuitmode:client:changeVehicleMode')
AddEventHandler('dyn-pursuitmode:client:changeVehicleMode', function()
    ...
    if IsPedInAnyVehicle(ped, false) then
        ...
        if DoesEntityExist(vehicle) and isValidVehicle(vehicle) and isAuthorizedToSwitchMode() then
            ...
            DynCore.Functions.Notify((Config.SwitchNotification):format(currentVehicleMode))
        end
    end
end)
...
RegisterCommand("pursuitmode", function(source, args, rawCommand)
    TriggerEvent('dyn-pursuitmode:client:changeVehicleMode')
end, false)
