...
RegisterNetEvent('dyn-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('dyn-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('dyn-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	DynCore.Functions.Notify(message, color)
end
