...
local PlayerJob = DynCore.Functions.GetPlayerData().job
...
RegisterNetEvent('dyn-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            params = {
                event = 'dyn-bossmenu:client:employeelist',
            }
        },
        {
            ...
            params = {
                event = 'dyn-bossmenu:client:HireMenu',
            }
        },
        {
            ...
            params = {
                isServer = true,
                event = 'dyn-bossmenu:server:stash',
            }
        },
        {
            ...
            params = {
                event = 'dyn-bossmenu:client:Wardrobe',
            }
        }
    }
    ...
    exports['dyn-menu']:openMenu(bossMenu)
end)

RegisterNetEvent('dyn-bossmenu:client:employeelist', function()
    local EmployeesMenu = {
        {
    ...
    DynCore.Functions.TriggerCallback('dyn-bossmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            EmployeesMenu[#EmployeesMenu + 1] = {
                ...
                params = {
                    event = 'dyn-bossmenu:client:ManageEmployee',
                    args = {
                        player = v,
                        work = PlayerJob
                    }
        ...
        EmployeesMenu[#EmployeesMenu + 1] = {
            ...
            icon = 'fa-solid fa-angle-left',
            params = {
                event = 'dyn-bossmenu:client:OpenMenu',
            }
        }
        exports['dyn-menu']:openMenu(EmployeesMenu)
    end, PlayerJob.name)
end)

RegisterNetEvent('dyn-bossmenu:client:ManageEmployee', function(data)
    local EmployeeMenu = {
        {
    ...
    for k, v in pairs(DynCore.Shared.Jobs[data.work.name].grades) do
        EmployeeMenu[#EmployeeMenu + 1] = {
            header = v.name,
            txt = Lang:t('body.grade') .. k,
            params = {
                isServer = true,
                event = 'dyn-bossmenu:server:GradeUpdate',
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = 'dyn-bossmenu:server:FireEmployee',
    ...
    exports['dyn-menu']:openMenu(EmployeeMenu)
end)

RegisterNetEvent('dyn-bossmenu:client:Wardrobe', function()
    TriggerEvent('dyn-clothing:client:openOutfitMenu')
end)

RegisterNetEvent('dyn-bossmenu:client:HireMenu', function()
    local HireMenu = {
        {
    ...
    DynCore.Functions.TriggerCallback('dyn-bossmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMenu[#HireMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = 'dyn-bossmenu:server:HireEmployee',
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['dyn-menu']:openMenu(HireMenu)
    end)
end)
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if not shownBossMenu then
                                        exports['dyn-core']:DrawText(Lang:t('drawtext.label'), 'left')
                                        shownBossMenu = true
                                    end
                                    if IsControlJustReleased(0, 38) then
                                        exports['dyn-core']:HideText()
                                        TriggerEvent('dyn-bossmenu:client:OpenMenu')
                                    end
                                end
