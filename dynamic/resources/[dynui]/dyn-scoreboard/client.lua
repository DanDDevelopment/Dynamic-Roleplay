...
RegisterNetEvent('dyn-scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            DynCore.Functions.TriggerCallback('dyn-scoreboard:server:GetScoreboardData', function(players, cops, playerList)
