# dyn-menu
Menu System for the DynCore Framework
...
RegisterCommand("qbmenutest", function(source, args, raw)
    openMenu({
        ...
        },
        {
            ...
            params = {
                event = "dyn-menu:client:testMenu2",
                args = {
                    number = 1,
                }
            }
...
```
```
RegisterNetEvent('dyn-menu:client:testMenu2', function(data)
    ...
    openMenu({
        ...
        },
        {
            ...
            txt = "Other",
            params = {
                event = "dyn-menu:client:testButton",
                args = {
...
```
```
RegisterNetEvent('dyn-menu:client:testButton', function(data)
    TriggerEvent('DynCore:Notify', data.message)
end)
```
