...
Dependency for creating progressbars in dyn-Core.
...
- Progress(**data**: string, **handler**: function)
  > Creates a new progress bar directly from the export, always use the built in dyn-core function if possible.<br>
  > **Example:**
  > ```lua
