const bankingApp = Vue.createApp({
    ...
    methods: {
        ...
        withdrawMoney() {
            ...
            axios
                .post("https://dyn-banking/withdraw", {
        ...
        depositMoney() {
            ...
            axios
                .post("https://dyn-banking/deposit", {
                    accountName: this.selectedMoneyAccount.name,
                    amount: this.selectedMoneyAmount,
                    reason: this.moneyReason,
                })
        ...
        internalTransfer() {
            ...
            axios
                .post("https://dyn-banking/internalTransfer", {
        ...
        externalTransfer() {
            ...
            axios
                .post("https://dyn-banking/externalTransfer", {
        ...
        orderDebitCard() {
            ...
            axios
                .post("https://dyn-banking/orderCard", {
                    pin: this.debitPin,
                })
                .then((response) => {
                    if (response.data.success) {
        ...
        openAccount() {
            ...
            axios
                .post("https://dyn-banking/openAccount", {
        ...
        renameAccount() {
            ...
            axios
                .post("https://dyn-banking/renameAccount", {
        ...
        deleteAccount() {
            ...
            axios
                .post("https://dyn-banking/deleteAccount", {
        ...
        addUserToAccount() {
            ...
            axios
                .post("https://dyn-banking/addUser", {
        ...
        removeUserFromAccount() {
            ...
            axios
                .post("https://dyn-banking/removeUser", {
                    accountName: this.manageAccountName.name,
                    userName: this.manageUserName,
                })
                .then((response) => {
