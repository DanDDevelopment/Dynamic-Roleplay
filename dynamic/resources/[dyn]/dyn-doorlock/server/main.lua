...
QBCore.Functions.CreateCallback('dyn-doorlock:server:setupDoors', function(_, cb)
	cb(Config.DoorList)
end)

QBCore.Functions.CreateCallback('dyn-doorlock:server:checkItems', function(source, cb, items, needsAll)
