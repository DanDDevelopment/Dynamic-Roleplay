...
AddStateBagChangeHandler('isLoggedIn', nil, function(_, _, value)
    if value then
        QBCore.Functions.TriggerCallback('dyn-drugs:server:RequestConfig', function(DealerConfig)
    ...
    if Config.UseTarget then
        ...
        drugDeliveryZone:onPlayerInOut(function(isPointInside)
            if isPointInside then
                ...
                exports['dyn-core']:DrawText(Lang:t('info.deliver_items_button', { itemAmount = activeDelivery['amount'], itemLabel = QBCore.Shared.Items[activeDelivery['itemData']['item']]['label'] }), 'left')
                CreateThread(function()
