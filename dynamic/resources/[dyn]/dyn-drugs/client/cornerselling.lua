            ...
            options = {
                {
                    ...
                    action = function()
                        ...
                        TriggerEvent('dyn-inventory:client:ItemBox', QBCore.Shared.Items[stealData.item], 'add')
                        stealingPed = nil
                        stealData = {}
...
RegisterNetEvent('dyn-drugs:client:cornerselling', function()
    QBCore.Functions.TriggerCallback('dyn-drugs:server:cornerselling:getAvailableDrugs', function(result)
