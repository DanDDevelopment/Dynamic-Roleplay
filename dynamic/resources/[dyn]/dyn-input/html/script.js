...
const OpenMenu = (data) => {
    ...
    let form = ["<form id='dyn-input-form'>", `<div class="heading">${data.header != null ? data.header : "Form Title"}</div>`];
    ...
    $("#dyn-input-form").on("change", function (event) {
    ...
    $("#dyn-input-form").on("submit", async function (event) {
        if (event != null) {
