...
QBCore.Functions.CreateCallback('dyn-scrapyard:checkOwnerVehicle', function(_, cb, plate)
...
RegisterNetEvent('dyn-scrapyard:server:ScrapVehicle', function(listKey)
    ...
    if Config.CurrentVehicles[listKey] ~= nil then
        ...
        if Luck == Odd then
            ...
            TriggerClientEvent('dyn-inventory:client:ItemBox', src, QBCore.Shared.Items['rubber'], 'add')
        end
