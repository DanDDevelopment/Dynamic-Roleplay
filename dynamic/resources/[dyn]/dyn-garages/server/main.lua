...
QBCore.Functions.CreateCallback('dyn-garages:server:getHouseGarage', function(_, cb, house)
    local houseInfo = MySQL.single.await('SELECT * FROM houselocations WHERE name = ?', { house })
    cb(houseInfo)
end)

QBCore.Functions.CreateCallback('dyn-garages:server:GetGarageVehicles', function(source, cb, garage, type, category)
...
QBCore.Functions.CreateCallback('dyn-garages:server:spawnvehicle', function(source, cb, plate, vehicle, coords)
...
QBCore.Functions.CreateCallback('dyn-garages:server:IsSpawnOk', function(_, cb, plate, type)
...
QBCore.Functions.CreateCallback('dyn-garages:server:canDeposit', function(source, cb, plate, type, garage, state)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('dyn-garages:server:GetPlayerVehicles', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    local Vehicles = {}
