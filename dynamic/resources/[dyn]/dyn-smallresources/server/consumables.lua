...
RegisterNetEvent('consumables:server:useHeavyArmor', function()
    ...
    TriggerClientEvent('dyn-inventory:client:ItemBox', source, QBCore.Shared.Items['heavyarmor'], 'remove')
...
RegisterNetEvent('consumables:server:useArmor', function()
    ...
    TriggerClientEvent('dyn-inventory:client:ItemBox', source, QBCore.Shared.Items['armor'], 'remove')
