...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('dyn-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('dyn-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('dyn-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('dyn-weathersync:client:DisableSync', function()
    disable = true
    SetRainLevel(0.0)
...
RegisterNetEvent('dyn-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('dyn-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
