...
RegisterNetEvent('dyn-gangmenu:client:ManageGang', function()
    ...
    QBCore.Functions.TriggerCallback('dyn-gangmenu:server:GetEmployees', function(cb)
...
RegisterNetEvent('dyn-gangmenu:client:HireMembers', function()
    ...
    QBCore.Functions.TriggerCallback('dyn-gangmenu:getplayers', function(players)
