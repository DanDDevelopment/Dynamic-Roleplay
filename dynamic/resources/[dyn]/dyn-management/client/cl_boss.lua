...
RegisterNetEvent('dyn-bossmenu:client:employeelist', function()
    ...
    QBCore.Functions.TriggerCallback('dyn-bossmenu:server:GetEmployees', function(cb)
...
RegisterNetEvent('dyn-bossmenu:client:HireMenu', function()
    ...
    QBCore.Functions.TriggerCallback('dyn-bossmenu:getplayers', function(players)
