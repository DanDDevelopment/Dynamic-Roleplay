...
-- Get Employees
QBCore.Functions.CreateCallback('dyn-gangmenu:server:GetEmployees', function(source, cb, gangname)
	local src = source
...
QBCore.Functions.CreateCallback('dyn-gangmenu:getplayers', function(source, cb)
	local src = source
	local players = {}
	local PlayerPed = GetPlayerPed(src)
