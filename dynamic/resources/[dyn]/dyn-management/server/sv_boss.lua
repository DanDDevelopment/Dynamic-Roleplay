...
-- Get Employees
QBCore.Functions.CreateCallback('dyn-bossmenu:server:GetEmployees', function(source, cb, jobname)
	local src = source
...
QBCore.Functions.CreateCallback('dyn-bossmenu:getplayers', function(source, cb)
	local src = source
	local players = {}
	local PlayerPed = GetPlayerPed(src)
