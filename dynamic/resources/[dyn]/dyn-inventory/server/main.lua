...
QBCore.Functions.CreateCallback('dyn-inventory:server:GetCurrentDrops', function(_, cb)
    cb(Drops)
end)

QBCore.Functions.CreateCallback('dyn-inventory:server:createDrop', function(source, cb, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then
        cb(false)
...
QBCore.Functions.CreateCallback('dyn-inventory:server:attemptPurchase', function(source, cb, data)
...
QBCore.Functions.CreateCallback('dyn-inventory:server:giveItem', function(source, cb, target, item, amount)
    local player = QBCore.Functions.GetPlayer(source)
