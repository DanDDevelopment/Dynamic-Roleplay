...
RegisterNUICallback('AttemptPurchase', function(data, cb)
    QBCore.Functions.TriggerCallback('dyn-inventory:server:attemptPurchase', function(canPurchase)
        cb(canPurchase)
    end, data)
end)
...
RegisterNUICallback('GiveItem', function(data, cb)
    ...
    if player ~= -1 and distance < 3 then
        ...
        QBCore.Functions.TriggerCallback('dyn-inventory:server:giveItem', function(success)
            cb(success)
...
RegisterNUICallback('RemoveAttachment', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('dyn-weapons:server:RemoveAttachment', function(NewAttachments)
